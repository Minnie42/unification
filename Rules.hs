...
rule6 
  ...
  (
    (
      BL (leftBind1:leftBind2:leftBinds), 
      BL (rightBind:rightBinds)
    ):gamma
  ) = 
  Just (
    rule6Iterate 
      (leftBind1:leftBind2:leftBinds) 
      [] 
      rightBind 
      rightBinds 
      sol 
...
rule6 
  ...
  (
    (
      BL (leftBind:leftBinds), 
      BL (rightBind1:rightBind2:rightBinds)
    ):gamma
  ) = 
  Just (
    rule6Iterate 
