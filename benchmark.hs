...
{-
(base) Ingas-MacBook-Air:unification_with_optimizations ingabaumgartner$ ghc -rtsopts -O -fforce-recomp sondertests.hs

(base) Ingas-MacBook-Air:unification_with_optimizations ingabaumgartner$ ./sondertests 2 +RTS -s
-}